...
.sm-scope .sm-logo-img { display: block; height: 104px; width: auto; object-fit: contain; }
...
.sm-scope .sm-socials-link:hover { color: #000; }
...
.sm-scope .sm-panel-item:hover { color: #000; }
